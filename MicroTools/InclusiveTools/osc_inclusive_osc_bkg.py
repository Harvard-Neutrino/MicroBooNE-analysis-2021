...
np.save(f'{MT.path_osc_data}/Dm41_SSq2EE_SSq2MM_PVs', np.asanyarray([dm41Vec, EVec, MVec], dtype=object))
...
if __name__ == '__main__':
    ...
    np.save(f'{MT.path_osc_data}/FullAnalysis_AppDis_SSq2EE_SSq2MM', res)

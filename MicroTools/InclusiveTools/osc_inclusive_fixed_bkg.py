...
MiniBooNE_Signal_PANM = np.loadtxt(f"{MT.mb_data_osctables}/dm-sin-MB-events-table-less-points.dat")
Result = []
Pairs = []
...
np.savetxt(f'{MT.path_osc_data}/Inclusive_NoBkgOsc_Chi2.dat', Result)
